...
.auth-in option { background:#1a1a22; color:#fff; }
    ...
    return (
        <>
            ...
            <div style={{ minHeight: "100vh", background: "#0d0d12", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Plus Jakarta Sans',sans-serif", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ width: "100%", maxWidth: 440, padding: "1.5rem", position: "relative", zIndex: 1, animation: "fadeUp .6s ease both" }}>
                    <div style={{ background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.09)", borderRadius: 24, padding: "2.5rem 2rem", backdropFilter: "blur(12px)" }}>
                        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
                            ...
                            <p style={{ color: "rgba(255,255,255,.38)", fontSize: "0.88rem", margin: 0 }}>Create your donor account</p>
                        </div>
                        <form onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="auth-btn" disabled={loading}>
                                {loading ? <span style={{ display: "inline-block", width: 18, height: 18, border: "2.5px solid rgba(255,255,255,.3)", borderTop: "2.5px solid #fff", borderRadius: "50%", animation: "spin .7s linear infinite", verticalAlign: "middle" }} /> : "Create Account →"}
                            </button>
                        </form>
                        <p style={{ textAlign: "center", marginTop: 20, color: "rgba(255,255,255,.35)", fontSize: "0.85rem" }}>
                            Have an account?{" "}<Link to="/" style={{ color: "#ff8a80", fontWeight: 700, textDecoration: "none" }}>Sign in</Link>
                        </p>
                    </div>
                </div>
            </div>
